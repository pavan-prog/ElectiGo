    ...
    <script>
        function validateForm(event) {
            ...
            if (nationality === "Non-Indian") {
                nationalityError.textContent = "We can't register Non-Indian candidates.";
                isValid = false;
            }
...
<body>
    <div class="navbar">
        <a href="/home">Home</a>
        <a href="/candidate/listByElection">Candidate List</a>
    ...
    <div class="container">
        ...
        <form action="/candidate/candidate_registration" method="post" enctype="multipart/form-data" onsubmit="validateForm(event)">
