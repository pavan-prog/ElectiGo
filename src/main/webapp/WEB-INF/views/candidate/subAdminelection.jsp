...
<body>
	...
	<div class="candidate-list-container">
		<div class="header-container">
			...
			<a href="/candidate/openRegistrationPage?election_id=<%= session.getAttribute("electionId") %>" class="add-candidate-btn">Add the Candidate</a>
			...
			<tbody>
				...
				<tr>
					...
					<td><label class="toggle-container"> <input
							...
							checked <%}%>
							onclick="window.location='/candidate/changeAuth/<%=candidateId%>'">
							<span class="toggle-slider"></span>
					</label></td>
					<td><a href="/candidate/changeNomination/<%= candidate.getCandidateId() %>">Change Nomination</a></td>
					<td><a
