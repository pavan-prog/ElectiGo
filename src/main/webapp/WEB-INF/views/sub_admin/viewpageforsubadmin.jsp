...
<body>
	...
	<div class="candidate-list-container">
		<div class="header-container">
			...
			<nav>
				<a href="/">Home</a> <a href="/subadmin/opendashboard">Dashboard</a>
			</nav>
			<input type="text" id="searchBox" class="search-box"
				placeholder="Search by name, aadhar or party name..."
		...
		List<CandidateWithElection> candidatesWithElection = (List<CandidateWithElection>) request
				.getAttribute("candidateWithElection");
		%>
		<table id="candidateTable">
			...
			<tbody>
				...
				<tr>
					...
					<td><img
						src="data:image/png;base64,<%=Utils.getBase64Image(candidate.getPartyLogo())%>"
						alt="Party Image" style="width: 35px; height: 50px" /></td>
					<td><%=candidate.getNumberOfVotes()%></td>
