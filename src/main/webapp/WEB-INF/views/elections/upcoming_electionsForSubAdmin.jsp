...
<body>
    ...
    <div class="top-nav">
        ...
        <a href="/subadmin/opendashboard" class="btn"><i class="fas fa-tachometer-alt"></i>Dashboard</a>
            ...
            if (elections != null && !elections.isEmpty()) {
                for (Election election : elections) { %>
                    <div class="election-card">
                        ...
                        <button onclick="window.location.href='/candidate/listByElectionForSubAdmin?electionId=<%= election.getElectionId() %>'">View Candidates</button>
                    </div>
            <% } } else { %>
